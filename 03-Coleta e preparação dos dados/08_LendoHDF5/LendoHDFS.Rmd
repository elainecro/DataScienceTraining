...
h5write(A, "example.h5","foo/A.mtx")
B = array(seq(0.1,2.0,by=0.1),dim=c(5,2,2))
attr(B, "scale") <- "liter"
h5write(B, "example.h5","foo/foobaa/B.arr")
h5ls("example.h5")
```
...
readA = h5read("example.h5","foo/A.mtx")
readB = h5read("example.h5","foo/foobaa/B.arr")
...
```{r ,dependson="read"}
h5write(c(12,13,14),"example.h5","foo/A.mtx",index=list(1:3,1))
h5read("example.h5","foo/A.mtx")
```
